...
public final class ViewDescriptor extends ResourceDescriptor {
    ...
    // ===== CONSTRUTOR PRIVADO → USA BUILDER =====
    ...
    private ViewDescriptor(Builder builder) {
        ...
        this.styleClasses = builder.styleClasses != null
                ? List.copyOf(builder.styleClasses)
                : Collections.emptyList();
        this.tags = builder.tags != null
                ? List.copyOf(builder.tags)
                : Collections.emptyList();
